    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.container}>
            ...
            <View style={styles.centerEmblem}>
              ...
              <View style={styles.emblemContainer}>
                <Image
                  ...
                  src={
                    emblem ||
                    "/placeholder.svg?height=32&width=32&query=State+emblem"
                  }
                />
              </View>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.date}>ದಿನಾಂಕ: {formattedTenderPublishDate}</Text>
        </View>
        ...
        <View style={styles.subjectSection}>
          <View style={styles.subjectRow}>
            ...
            <Text style={styles.subjectContent}>
              ...
              ಕೈಗೊಳ್ಳಲಾಗುವ ಕಾಮಗಾರಿಗಳಿಗೆ ಸಾಮಗ್ರಿ ಸರಬರಾಜು ಮಾಡಲು ದರಪಟ್ಟಿ ಆಹ್ವಾನಿಸುವ
              ಬಗ್ಗೆ.{" "}
            </Text>
          </View>
          <View style={styles.referenceSection}>
            ...
            <View style={styles.referenceContent}>
              ...
              <Text>
                2) ಕಾಮಗಾರಿ ಆಡಳಿತಾತ್ಮಕ ಅನುಮೋದನೆ ಸಂಖ್ಯೆ : {administrativeSanction}
              </Text>
        ...
        <Text style={styles.mainContent}>
          ...
          ಗಾಂಧಿ ರಾಷ್ಟ್ರೀಯ ಗ್ರಾಮೀಣ ಉದ್ಯೋಗ ಖಾತ್ರಿ ಯೋಜನೆಯಲ್ಲಿ ಕೈಗೊಳ್ಳಲಾಗುವ{" "}
          {workName} ({workCode} ) ಕಾಮಗಾರಿ ಅನುಷ್ಠಾನ ಮಾಡಲು ಈ ಕೆಳಕಂಡ ಸಾಮಗ್ರಿಗಳು
          ಅವಶ್ಯವಿದ್ದು, ಅವುಗಳನ್ನು ಅಹರ್ GST ನಂಬರ್ ಹೊಂದಿರುವ ಸರಬರಾಜುದಾರರಿಂದ
          ದರಪಟ್ಟಿಯನ್ನು ಆಹ್ವಾನಿಸಲಾಗಿದೆ. ಆಸಕ್ತಿ ಹೊಂದಿರುವ ಸರಬರಾಜುದಾರರು ಇದಕ್ಕೆ
          ಲಗತ್ತಿಸಿದ ನಮೂನೆಯಲ್ಲಿ ಐಟಂವಾರು ಅಂಕಿ & ಅಕ್ಷರಗಳಲ್ಲಿ ದರವನ್ನು ನಮೂದಿಸಿ, ಸದರಿ
          ದರಪಟ್ಟಿಯನ್ನು ದಿನಾಂಕ {formattedTenderSubmissionDate} ರಂದು ಸಂಜೆ 5.00
          ಗಂಟೆಯೊಳಗಾಗಿ ಈ ಕಛೇರಿಗೆ ಈ ಕೆಳಕಂಡ ಷರತ್ತುಗಳಿಗೆ ಒಳಪಟ್ಟು ಸಲ್ಲಿಸತಕ್ಕದ್ದು,
          ನಂತರ ಬರುವ ಯಾವುದೇ ದರಪಟ್ಟಿಗಳನ್ನು ಸ್ವೀಕರಿಸುವುದಿಲ್ಲ.
        </Text>
        ...
        <View wrap={false}>
          <View style={styles.termsSection}>
            ...
            <Text style={styles.termItem}>
              3) ಆಯ್ಕೆಯಾದ ಸರಬರಾಜುದಾರರು ಸಾಮಗ್ರಿಗಳನ್ನು ತಮ್ಮ ಖರ್ಚಿನಲ್ಲಿಯೇ ಕಾಮಗಾರಿ
              ಸ್ಥಳಕ್ಕೆ ಸರಬರಾಜು ಮಾಡಲು ಬದ್ಧರಾಗಿರಬೇಕು.
            </Text>
            <Text style={styles.termItem}>
            ...
            <Text style={styles.termItem}>
              5) ಸಾಮಗ್ರಿ ಬಿಲ್ಲನ್ನು ಸರ್ಕಾರವು ಅನುದಾನ ಬಿಡುಗಡೆ ಮಾಡಿದಾಗ ಸ್ವೀಕರಿಸಲು
              ಬದ್ಧರಾಗಿರಬೇಕು ಸಾಮಗ್ರಿ ಬಿಲ್ಲನ್ನು ಸರ್ಕಾರವು ಅನುದಾನ ಬಿಡುಗಡೆ ಮಾಡಿದಾಗ
              ಸ್ವೀಕರಿಸಲು ಬದ್ಧರಾಗಿರಬೇಕು ಸಾಮಗ್ರಿ ಬಿಲ್ಲನ್ನು ಸರ್ಕಾರವು ಅನುದಾನ ಬಿಡುಗಡೆ
              ಮಾಡಿದಾಗ ಸ್ವೀಕರಿಸಲು ಬದ್ಧರಾಗಿರಬೇಕು
            </Text>
            <Text style={styles.termItem}>
              6) ಸಾಮಗ್ರಿ ಸರಬರಾಜು ಆದೇಶ ನೀಡುವ ಸಂದರ್ಭದಲ್ಲಿ ಗ್ರಾಮ ಪಂಚಾಯಿತಿಯು ವಿಧಿಸುವ
              / ಒಪ್ಪುವ ಇನ್ನಿತರ ಷರತ್ತುಗಳಿಗೆ ಬದ್ಧರಾಗಿರಬೇಕು.
            </Text>
          </View>
          ...
          <View style={styles.copySection}>
            ...
            <Text style={styles.textbottom}>1. ಸ್ಥಳೀಯ ಅಹರ್ ಸರಬರಾಜುದಾರಿಗೆ</Text>
