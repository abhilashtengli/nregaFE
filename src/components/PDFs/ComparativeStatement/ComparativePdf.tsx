  ...
  return (
    <Page size="A4" orientation="landscape" style={styles.page}>
      <View style={styles.container}>
        {/* Header: This content will only appear on the first page. */}
            ...
            <View style={styles.centerEmblem}>
              ...
              <View style={styles.emblemContainer}>
                <Image
                  ...
                  src={
                    emblem ||
                    "/placeholder.svg?height=24&width=24&query=State+emblem"
                  }
                />
              </View>
        ...
        <Text style={styles.description}>
          ...
          <Text style={styles.highlight}>{year}</Text> ನೇ ಸಾಲಿನ ಮಹಾತ್ಮ ಗಾಂಧಿ
          ರಾಷ್ಟ್ರೀಯ ಗ್ರಾಮೀಣ ಉದ್ಯೋಗ ಖಾತ್ರಿ ಯೋಜನೆಡಿ ಅನುಷ್ಠಾನಗೊಳಿಸುತ್ತಿರುವ{" "}
          <Text style={styles.highlight}>{workName}</Text>(
          <Text style={styles.highlight}>{workCode}</Text>) ಕಾಮಗಾರಿ ಅನುಷ್ಠಾನ
          ಮಾಡಲು ಆಹ್ವಾನಿಸಿರುವ ದರಪಟ್ಟಿಗೆ ಅನುಗುಣವಾಗಿ ಸಾಮಗ್ರಿ ಸರಬರಾಜು ಮಾಡಲು ಬಂದಿರುವ
          ಸರಬರಾಜುದಾರರ ದರಪಟ್ಟಿಗಳ ತುಲನಾತ್ಮಕ ಪಟ್ಟಿ.
        </Text>

        {/* Comparative Table */}
        <View style={styles.table}>
          {/* Table Header: `fixed` prop repeats it on every page. */}
          ...
          {/* This placeholder reserves space for the fixed header on the first page. */}
          <View style={styles.tableHeader} />

          {/* Table Rows: `wrap={false}` prevents rows from splitting across pages. */}
        ...
        {/* Footer: `wrap={false}` ensures this section stays together on the last page. */}
        <View wrap={false}>
          ...
          <View style={styles.signatureSection}>
            <View style={styles.signatureItem}>
              <Text style={styles.signatureTitle}>ನರೇಗಾ ತಾಂತ್ರಿಕ ಸಹಾಯಕರು</Text>
