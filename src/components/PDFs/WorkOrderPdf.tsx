        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.contentItem}>
            <Text style={styles.referenceText}>
              <Text style={styles.kannadaText}>ಉಲ್ಲೇಖ:</Text> ಮಹಾತ್ಮಾಗಾಂಧಿ ನರೇಗಾ
              ಯೋಜನೆಯ ಮಾರ್ಗಸೂಚಿ ಪ್ರಕಾರ{" "}
            </Text>
          </View>
          ...
          <Text style={styles.mainParagraph}>
            ...
            ಒದಗಿಸಬೇಕಾಗಿರುವುದರಿಂದ ಅನುಮೋದಿತ ಕ್ರೀ{""}ಯಾ ಯೋಜನೆಯಲ್ಲಿ ಅಳವಡಿಸಿದ ಈ
            ಕೆಳಕಂಡ ಕಾಮಗಾರಿಯನ್ನು ಈ ಕೆಳಗಿನ ಷರತ್ತಿಗೊಳಪಟ್ಟು ಕಾಮಗಾರಿಗಳನ್ನು
            ಪ್ರಾರಂಭಿಸಲು "ಕಾಮಗಾರಿ ಆದೇ{""}ಶ ಪತ್ರ ನೀಡಲಾಗಿದೆ. ಕಾರಣ ನಿಗದಿತ ಅವಧಿಯಲ್ಲಿ
            ಕಾಮಗಾರಿಯನ್ನು ಪ್ರಾರಂಭಿಸುವುದು.
          </Text>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableDataRow}>
              ...
              <Text
                style={[styles.tableCell, styles.gramCell, styles.kannadaText]}
              >
                {grama}
              </Text>
