      ...
      <View style={styles.container}>
        ...
        <View style={styles.headerSection}>
          ...
          <View style={styles.centerHeader}>
            ...
            <Text style={styles.headerSubText}>ಅನುಬಂಧ - III A/B (ನಮೂನೆ-6)</Text>
        ...
        <Text style={styles.justifyText}>
          ಮಹಾತ್ಮಾ ಗಾಂಧಿ ನರೇಗಾ ಯೋಜನೆ ಅನುಸೂಚಿ II ಕಂಡಕೆ 9 ಕಾಯ್ 3(1) ರಂತೆ ಕೆಲಸಕ್ಕಾಗಿ
          ಅರ್ಜಿ ಸಲ್ಲಿಸುತ್ತಿದ್ದೇವೆ. ಇದರ ಪ್ರಕಾರ ನಮ್ಮ ಕೋರಿಕೆಯನು ಮತ್ತು ನಮ್ಮ ಉದ್ಯೋಗದ
          ಅವಧಿಯ ವಿವರವನ್ನು ನೀಡುತ್ತಿದ್ದೇವೆ.
        </Text>
        ...
        <View style={styles.table}>
          ...
          {applicantsData.map((applicant) => (
            <View key={applicant.slNo} style={styles.tableRow} wrap={false}>
              ...
              >
                <Text style={styles.durationSubCell}>{applicant.workFrom}</Text>
